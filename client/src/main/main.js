System.register(['angular2/core', 'angular2/router', 'ng2-ui-auth', 'ng2-ui-auth/src/shared', 'angular2/http'], function(exports_1) {
    "use strict";
    ...
    var core_1, router_1, ng2_ui_auth_1, shared_1, http_1;
    var Overview, Main;
    return {
        setters:[
            function (core_1_1) {
            ...
            Main = (function () {
                ...
                Main = __decorate([
                    core_1.Component({
                        ...
                        providers: [core_1.provide(ng2_ui_auth_1.JwtHttp, {
                                useFactory: function (xhrBackend, requestOptions, shared, config, router) {
                                    return new ng2_ui_auth_1.JwtHttp(xhrBackend, requestOptions, shared, config);
                                },
                                deps: [http_1.XHRBackend, http_1.RequestOptions, shared_1.Shared, ng2_ui_auth_1.Config],
                            })],
                        directives: [router_1.ROUTER_DIRECTIVES]
                    }),
